    ...
    if (warehouse_1_count + warehouse_2_count) != 0:
        ...
        for x in stock:
            ...
            if item_name.lower() == user_item.lower():
                ...
                in_stock_since = datetime.strptime(
                    x["date_of_stock"], "%Y-%m-%d %H:%M:%S"
                )
...
while (
            ...
            if order_yn == "Y":
                while (
                    ...
                    if ordered_item > total_amount(stock, user_item):
                        ...
                        if max_amount == "Y":
                            print(
                                f"{user_item} ordered: {total_amount(stock, user_item)}"
                            )
                            valid_amount = True
                        else:
                            valid_amount = False
    ...
    #  CHOICE 3
        ...
        browse_category = int(
            input("Enter the number of the category you want to browse: ")
        )
        print()
